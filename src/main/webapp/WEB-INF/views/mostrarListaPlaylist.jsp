	...
	<div class="modal fade" id="crearPlaylist" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  		<div class="modal-dialog" role="document">
    		<div class="modal-content" style="background: #272c33ed;">
	      		...
	      		<form:form method="POST" action="guardarPlaylist" modelAttribute="playlist">
		  		...
		  		<div class="col-sm-3 mb-3">
		    		<div class="card text-center border border-dark" style="background: #8a959e14;">
		      			<div class="card-body">
		        			...
		        			<a href="listaCancionesPlaylist/${playlist.idPlaylist}" class="btn btn-outline-secondary mr-2">Abrir</a>
		        			<a href="/SpotiFakeSolWeb/eliminarPlaylist/${playlist.idPlaylist}" class="btn btn-outline-secondary mr-2">Eliminar</a>
		      			</div>
		    		</div>
		  		</div>
		  	</c:forEach>
